/**
 * T-008 — `UI-UX-DESIGN.md` "Content rules": `"Mon D – Mon D, YYYY"` campaign date range format.
 * Same assertions as `features/dashboard/formatDateRange.test.ts` (T-007) — this module is a
 * deliberate duplicate, see `formatDateRange.ts`'s own header.
 */
