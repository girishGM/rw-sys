/**
 * T-008 — `UI-UX-DESIGN.md` "Content rules": campaign dates use a `"Mon D – Mon D, YYYY"` range
 ...
 * where the demo happens to run. A deliberate duplicate of `features/dashboard/formatDateRange.ts`
 * (T-007) — see `campaignTheme.ts`'s header in this same folder for why these two feature scopes
