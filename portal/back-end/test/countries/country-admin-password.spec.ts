/**
 * T-030 — `generateTemporaryPassword`: server-generated, CSPRNG, unambiguous alphabet
 * (BACKLOG.md B-01, implementation note 5).
 */
import { generateTemporaryPassword } from '@/modules/countries/country-admin-password';
...
describe('generateTemporaryPassword', () => {
  ...
  it('always contains at least one lowercase, one uppercase, one digit and one symbol (composition policies are satisfied by construction)', () => {
    for (let i = 0; i < 200; i += 1) {
